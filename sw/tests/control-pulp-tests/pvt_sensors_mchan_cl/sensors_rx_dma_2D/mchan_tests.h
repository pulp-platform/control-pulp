...
static inline void
mchan_transfer(unsigned int len, char type, char incr, char twd_ext,
	       char twd_tcdm, char ele, char ile, char ble,
	       unsigned int ext_addr, unsigned int tcdm_addr,
	       unsigned int ext_count, unsigned int ext_stride,
	       unsigned int tcdm_count, unsigned int tcdm_stride)
{
...
static inline void
fc_mchan_transfer(unsigned int len, char type, char incr, char twd_ext,
		  char twd_tcdm, char ele, char ile, char ble,
		  unsigned int ext_addr, unsigned int tcdm_addr,
