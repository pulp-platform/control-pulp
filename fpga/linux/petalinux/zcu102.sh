...
# $PETALINUX_VER petalinux-config --get-hw-description "$THIS_DIR/../../control_pulp-txilzu9eg/control_pulp-txilzu9eg/control_pulp-txilzu9eg.sdk"
$PETALINUX_VER petalinux-config --get-hw-description="../../../control_pulp-txilzu9eg/pms.xsa" --silentconfig
...
if [ ! -d "linux-xlnx" ]; then
  ...
  git clone --depth 1 --single-branch --branch xlnx_rebase_v6.6 https://github.com/Xilinx/linux-xlnx
fi
cd linux-xlnx
...
$PETALINUX_VER petalinux-build -x mrproper
$PETALINUX_VER petalinux-build
